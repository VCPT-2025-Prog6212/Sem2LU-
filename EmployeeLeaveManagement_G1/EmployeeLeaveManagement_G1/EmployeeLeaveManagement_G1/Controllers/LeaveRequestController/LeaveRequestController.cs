...
namespace EmployeeLeaveManagement_G1.Controllers.LeaveRequestController
{
    public class LeaveRequestController : Controller
    {
        ...
        {
            ViewBag.Message = "All Leave Requests Dashboard!";            
        ...
        public IActionResult Create(LeaveRequest leaveRequest) 
        {
            ...
            _leaveRequests.Add(leaveRequest);//Add the new leave request to the in-memory list
        ...
        { var leaveRequest = _leaveRequests.FirstOrDefault(lr => lr.LeaveRequestID == id);
            ...
            return View(leaveRequest);//pass the leave request to the "Details" view for display
        }
